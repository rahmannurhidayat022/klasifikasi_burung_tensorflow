...
img_pred_dir = BASE_DIR + '/prediction/bali_starling_test.jpg'
...
# prediction_img = ['test1', 'test2']


# def test(prediction_img):

#     for x in prediction_img:
#         img_pred_dir = BASE_DIR + '/prediction/' + x + '.jpg'
